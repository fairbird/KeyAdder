...
class VirtualKeyBoardKeyAdder(Screen, HelpableScreen):
	def __init__(self, session, title=_("Virtual KeyBoard Text:"), text="", maxSize=False, visible_width=False, type=Input.TEXT, currPos=None, allMarked=False, style=VKB_ENTER_ICON):
		...
		if isHD():
			self.skin = SKIN_HD
			self.bg = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_bg.png"))  # Legacy support only!
			self.bg_l = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_bg_l.png"))
			self.bg_m = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_bg_m.png"))
			self.bg_r = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_bg_r.png"))
			self.sel_l = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_sel_l.png"))
			self.sel_m = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_sel_m.png"))
			self.sel_r = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_sel_r.png"))
			key_red_l = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_red_l.png"))
			key_red_m = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_red_m.png"))
			key_red_r = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_red_r.png"))
			key_green_l = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_green_l.png"))
			key_green_m = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_green_m.png"))
			key_green_r = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_green_r.png"))
			key_yellow_l = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_yellow_l.png"))
			key_yellow_m = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_yellow_m.png"))
			key_yellow_r = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_yellow_r.png"))
			key_blue_l = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_blue_l.png"))
			key_blue_m = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_blue_m.png"))
			key_blue_r = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_blue_r.png"))
			key_backspace = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_backspace.png"))
			key_clear = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_clear.png"))
			key_delete = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_delete.png"))
			key_enter = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_enter.png"))
			key_exit = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_exit.png"))
			key_first = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_first.png"))
			key_last = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_last.png"))
			key_left = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_left.png"))
			key_locale = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_locale.png"))
			key_right = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_right.png"))
			key_shift = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_shift.png"))
			key_shift0 = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_shift0.png"))
			key_shift1 = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_shift1.png"))
			key_shift2 = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_shift2.png"))
			key_shift3 = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_shift3.png"))
			key_space = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_space.png"))
			key_space_alt = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsHD/vkey_space_alt.png"))
		else:
			self.skin = SKIN_FHD
			self.bg = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_bg.png"))  # Legacy support only!
			self.bg_l = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_bg_l.png"))
			self.bg_m = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_bg_m.png"))
			self.bg_r = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_bg_r.png"))
			self.sel_l = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_sel_l.png"))
			self.sel_m = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_sel_m.png"))
			self.sel_r = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_sel_r.png"))
			key_red_l = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_red_l.png"))
			key_red_m = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_red_m.png"))
			key_red_r = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_red_r.png"))
			key_green_l = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_green_l.png"))
			key_green_m = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_green_m.png"))
			key_green_r = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_green_r.png"))
			key_yellow_l = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_yellow_l.png"))
			key_yellow_m = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_yellow_m.png"))
			key_yellow_r = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_yellow_r.png"))
			key_blue_l = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_blue_l.png"))
			key_blue_m = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_blue_m.png"))
			key_blue_r = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_blue_r.png"))
			key_backspace = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_backspace.png"))
			key_clear = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_clear.png"))
			key_delete = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_delete.png"))
			key_enter = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_enter.png"))
			key_exit = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_exit.png"))
			key_first = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_first.png"))
			key_last = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_last.png"))
			key_left = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_left.png"))
			key_locale = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_locale.png"))
			key_right = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_right.png"))
			key_shift = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_shift.png"))
			key_shift0 = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_shift0.png"))
			key_shift1 = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_shift1.png"))
			key_shift2 = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_shift2.png"))
			key_shift3 = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_shift3.png"))
			key_space = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_space.png"))
			key_space_alt = LoadPixmap(path=resolveFilename(SCOPE_PLUGINS, "Extensions/KeyAdder/tools/VirtualKeyBoard_Icons/buttonsFHD/vkey_space_alt.png"))
		...
		self["actions"] = HelpableNumberActionMap(self, ["VirtualKeyBoardActions", "NumberActions", "TextEditActions"], {
			...
			"PASTE": (self.PasteKey, _("Paste the key text")),
